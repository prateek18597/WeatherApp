 ...
 * @author SCEA
 */
public class WeatherAPI extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WeatherAPI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
